...
export function Project(props: ProjectProps) {
	return (
		...
		<a href={props.link} className="flex flex-row items-start justify-start gap-2 border-2 bg-gray-900 bg-opacity-10 hover:bg-opacity-20 transition-opacity border-white w-full h-fit rounded-lg hover:shadow-md p-4">
