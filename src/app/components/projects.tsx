    ...
    const projects: ProjectProps[] = [
        {
            ...
            description:
        "Open-source, encrypted note sharing with zero-knowledge encryption, self-destructing notes, and anonymous rate limiting.",
        ...
        },
        {
            ...
            description:
        "The official website for the BIPoC Climate Justice Conference 2024 & 2025. Featuring localized content and 100% markdown support using static site generation.",
        ...
        },
        {
            title: "WatchLock",
            icon:
        "https://github.com/emilkrebs/WatchLock/raw/main/images/WatchLock.webp",
            description:
        "An Android & WearOS app to lock your phone using your smartwatch. Built for personal security.",
        ...
        },
        {
            ...
            icon: "/favicon.svg",
            description:
        "My personal website built with Next.js, Tailwind CSS and TypeScript using static site generation for fast performance.",
            link: "/",
        ...
        },
        {
            ...
            icon:
        "https://github.com/emilkrebs/Generator-Discord/raw/main/assets/icon.svg",
            description:
        "A Yeoman generator for Discord bots supporting multiple languages, simplifying bot creation with templates.",
        ...
        },
        {
            ...
            description:
        "Showcases for custom Domain-Specific Languages (DSLs) built with Langium (State Machine, Arithmetics, MiniLogo, Domain Model)",
                    ...
                    <header className="flex items-start gap-3 sm:gap-4">
                        {props.icon && (
                            <div className="relative flex-shrink-0">
                                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 rounded-lg sm:rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-300">
                                </div>
                                <Image
                                    src={props.icon}
