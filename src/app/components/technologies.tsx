                            ...
                            >
                                {section.technologies.map((technology, techIndex) => (
                                    <div
                                        ...
                                        style={{
                                            animationDelay: `${
                                                (sectionIndex * section.technologies.length +
                          techIndex) * 0.1
                                            }s`,
                                        }}
                                    >
                                        <div className="relative flex-shrink-0">
                                            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 rounded-lg blur opacity-0 group-hover:opacity-30 transition-opacity duration-300">
                                            </div>
                                            <Image
